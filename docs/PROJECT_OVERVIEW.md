...
- Empresas/SAT/consulta de manifestação (**P2-01..P2-11**, **P2-13** docs) já estão no client e no README como disponíveis. DTO emissão NFS-e (**P1-01**: `Nfse`/`Servico`), `EmitirNfse` (**P1-02**), `ConsultaNfse` (**P1-03**), `ConsultaNfsePorIdExterno` (**P1-04**), `ListarNfse` (**P1-05**, model `ListaNfse`), `CancelaNfse` (**P1-06**) e `CancelaNfsePorIdExterno` (**P1-07**) já existem; demais métodos NFS-e (**P1-08+**) e envio de manifestação (**P2-12**, bloqueado) ainda fora do client.
