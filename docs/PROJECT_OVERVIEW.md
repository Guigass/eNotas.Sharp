...
- README lista NFS-e e restante da gestão de empresas (SAT/habilitar) como futuros; `IncluirAlterarEmpresa` (**P2-02**), `ConsultaEmpresa` (**P2-03**), `ListarEmpresas` (**P2-04**), `VincularCertificadoDigital` (**P2-05**) e `VincularLogotipo` (**P2-06**) já estão no client. Postman V1 cobre NFS-e, mas o client C# ainda não implementa esses métodos.
