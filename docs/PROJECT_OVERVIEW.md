...
- Empresas/SAT/consulta de manifestação (**P2-01..P2-11**, **P2-13** docs) já estão no client e no README como disponíveis. DTO emissão NFS-e (**P1-01**: `Nfse`/`Servico`; **P1-11**: Reforma `codigoNBS`/`codigoTributacaoNacional`/`ServicoIbsCbs`), `EmitirNfse` (**P1-02**), `ConsultaNfse` (**P1-03**), `ConsultaNfsePorIdExterno` (**P1-04**), `ListarNfse` (**P1-05**, model `ListaNfse`), `CancelaNfse` (**P1-06**), `CancelaNfsePorIdExterno` (**P1-07**), `ConsultaNfseXML` e `ConsultaNfseXMLPorIdExterno` (**P1-08**, XML em `Message`), `ConsultaNfsePDF` e `ConsultaNfsePDFPorIdExterno` (**P1-09**, bytes em `Object`), apoio municipal (**P1-10**, body em `Message`) já existem; docs NFS-e (**P1-12**) e envio de manifestação (**P2-12**, bloqueado) ainda abertos.
- Lacunas e priorização do backlog estão em `ROADMAP.md` (gaps restantes de models P0, NFS-e P1-11+, envio de manifestação P2-12, qualidade P3).
