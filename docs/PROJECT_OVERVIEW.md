...
- README lista NFS-e e restante da gestão de empresas (cert/logo/SAT) como futuros; `IncluirAlterarEmpresa` (**P2-02**), `ConsultaEmpresa` (**P2-03**) e `ListarEmpresas` (**P2-04**) já estão no client. Postman V1 cobre NFS-e, mas o client C# ainda não implementa esses métodos.
