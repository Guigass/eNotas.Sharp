...
- Models de emissão → composição (`Nota` → `Cliente`, `Iten`, `Impostos`, `Pedido`, `Transporte`, …); NFS-e V1 → `Nfse` → `Cliente`, `Servico` (**P1-01**; `EmitirNfse` / **P1-02**)
...
- Coleção Postman V1 (NFS-e) é referência de contrato para o backlog **P1**; DTO emissão (`Nfse`/`Servico`, **P1-01**) e `EmitirNfse` (**P1-02**) no client; demais métodos P1-03+.
